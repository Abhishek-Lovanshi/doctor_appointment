                    ...
                    <tr>
                        <td >
                            ...
                            <!-- <p>Haven't any idea about doctors? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Counellors"</b></a> section or 
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Channel a Counellor &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
